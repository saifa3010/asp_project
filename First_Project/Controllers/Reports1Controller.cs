...
{
    public class Reports1Controller : Controller
    {
        private readonly ModelContext _context;

        public Reports1Controller(ModelContext context)
        {
            _context = context;
        }
